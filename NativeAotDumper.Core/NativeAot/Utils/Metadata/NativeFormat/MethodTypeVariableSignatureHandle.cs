...
[CLSCompliant(false)]
public readonly struct MethodTypeVariableSignatureHandle
{
	...
	{
		_ = (byte)(value >>> 25);
		_value = (value & 0x1FFFFFF) | 0x58000000;
	}
	...
	{
		return new MethodTypeVariableSignature(reader, this);
	}

	[Conditional("DEBUG")]
	internal void _Validate()
	{
		if ((byte)(_value >>> 25) != 44)
		{
